...
<div id="container" class="p-privacypolicy l-noBg">
    ...
    <main role="main" class="l-page__main">
        ...
        <section class="l-sec">
            ...
            <div class="c-ttlBox">
                <h2 class="c-ttl">Privacy Policy</h2>
            </div>

            <div class="l-wrapper">

                <div class="c-policyBox">
                    <div class="c-policyBox__content">
                        <h2 class="c-ttl01">個人情報保護方針</h2>
                        <div>
                            <h3>第1条（個人情報）</h3>
                        ...
                        <div>
                            <h3>第2条（個人情報の収集方法）</h3>
                            <p>当社は，個人情報を取得する際に氏名，生年月日，住所，電話番号，メールアドレス，銀行口座番号，クレジットカード番号，運転免許証番号などの個人情報をお尋ねすることがあります。また，ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を,当社の提携先（情報提供元，広告主，広告配信先などを含みます。以下，｢提携先｣といいます。）などから収集することがあります。</p>
                        </div>

                        <div>
                            <h3>第3条（個人情報を収集・利用する目的）</h3>
                            <p class="u-mb_0">当社が個人情報を収集・利用する目的は，以下のとおりです。</p>
                            <ol>
                                ...
                                <li>採用活動において，候補者への連絡，選考，人事管理をするため</li>
                            </ol>
                            <p>上記の利用目的に付随する目的</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="mb_33">ユーザーは，当社の保有する自己の個人情報が誤った情報である場合には，当社が定める手続きにより，当社に対して個人情報の訂正，追加または削除（以下，「訂正等」といいます。）を請求することができます。</p>
                            <p class="mb_33">当社は，ユーザーから前項の請求を受けてその請求に応じる必要があると判断した場合には，遅滞なく，当該個人情報の訂正等を行うものとします。</p>
                        ...
                        <div>
                            ...
                            <p class="mb_33">前項の調査結果に基づき，その請求に応じる必要があると判断した場合には，遅滞なく，当該個人情報の利用停止等を行います。</p>
                            <p class="mb_33">当社は，前項の規定に基づき利用停止等を行った場合，または利用停止等を行わない旨の決定をしたときは，遅滞なく，これをユーザーに通知します。</p>
                        ...
                        <div>
                            ...
                            <p class="mb_33">本ポリシーの内容は，法令その他本ポリシーに別段の定めのある事項を除いて，ユーザーに通知することなく，変更することができるものとします。</p>
                        ...
                        <div>
                            ...
                            <p class="mb_0">〒105-0004 東京都港区新橋2-16-1 ニュー新橋ビル802<br>
                            Terra Motors株式会社<br>
                            <a href="" id="js-mailContact">xxxxx</a></p>
                        </div>
                    </div>
                </div>
