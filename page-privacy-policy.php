            ...
            <section class="l-sec">
                ...
                <div class="l-wrapper">
                    ...
                    <div class="c-policyBox">
                        <div class="c-policyBox_content">
                            <h2>個人情報の取り扱いについて</h2>
                            <p>株式会社イッパイアッテナ(以下、「当社」といいます。)は、本ウェブサイト上で提供するサービス(以下、「本サービス」といいます。)におけるユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー(以下、「本ポリシー」といいます。)を定めます。</p>
                            ...
                            <h3>■第10条(お問い合わせ窓口)</h3>
                            <p class="u-mb_0">本ポリシーに関するお問い合わせは、お問い合わせよりお願いいたします。<br>
                                会社名：株式会社イッパイアッテナ<br>
                                info@example.co.jp
                            </p>
