    ...
    <div class="column_1">
        ...
        <main role="main" class="l-page__main">
			...
			<section class="p-microfinance__case l-sec --bgImage">
				...
				<div class="l-wrapper">
					<p class="p-microfinance__case__lead c-slideup init d_50">テラモーターズは、エンドユーザーであるドライバーだけでなく、<br class="u-hide_sp">政府やビジネスセクターとの戦略的提携により、社会的価値、インパクトを生み出すEVエコシステムの構築に挑戦しています。</p>
