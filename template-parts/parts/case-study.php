...
<div class="l-wrapper">
  ...
  <p class="p-front__case__lead c-slideup init d_50">テラモーターズは、エンドユーザーであるドライバーだけでなく、<br class="u-hide_sp">政府やビジネスセクターとの戦略的提携により、社会的価値、インパクトを生み出す<br class="u-hide_sp">EVエコシステムの構築に挑戦しています。</p>
  ...
  <ul class="p-front__case__list">
    ...
    <li class="p-front__case__item --bc c-slideup init d_50">
      <a href="<?php echo esc_url(home_url('/business-collaboration/')); ?>" class="p-front__case__item-box">
    ...
    <li class="p-front__case__item --ig c-slideup init d_50">
      <a href="<?php echo esc_url(home_url('/initiatives-with-governments/')); ?>" class="p-front__case__item-box">
