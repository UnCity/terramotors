...
<section class="p-ecosystem01 l-sec">
    ...
    <div class="l-wrapper c-slideup init d_50">
        ...
        <p>EV3輪事業から始まったテラモーターズですが、<br>EV３輪を購入するドライバーたちは、ガソリン車と比較して高価格であるEV車を購入する経済的余裕がないことを知りました。<br>テラファイナンスは、そういったドライバーへ機会提供することを目的に始まりました。<br>エンドユーザーにとって、EVがより身近になるよう、テラモーターズはE Vエコシステムをアップデートし続けています。</p>
